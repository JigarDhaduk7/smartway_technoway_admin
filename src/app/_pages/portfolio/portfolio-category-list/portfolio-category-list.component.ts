...
@Component({
  selector: 'app-portfolio-category-list',
  templateUrl: './portfolio-category-list.component.html',
  styleUrls: ['./portfolio-category-list.component.scss']
})
export class PortfolioCategoryListComponent implements OnInit {
