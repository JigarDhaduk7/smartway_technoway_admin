...
@Component({
  selector: 'app-portfolio-tag-list',
  templateUrl: './portfolio-tag-list.component.html',
  styleUrls: ['./portfolio-tag-list.component.scss']
})
export class PortfolioTagListComponent implements OnInit {
