...
@Component({
  selector: 'app-service-enquiry-list',
  templateUrl: './service-enquiry-list.component.html',
  styleUrls: ['./service-enquiry-list.component.scss']
})
export class ServiceEnquiryListComponent implements OnInit {
