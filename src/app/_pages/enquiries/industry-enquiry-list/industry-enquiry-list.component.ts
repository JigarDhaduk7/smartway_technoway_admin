...
@Component({
  selector: 'app-industry-enquiry-list',
  templateUrl: './industry-enquiry-list.component.html',
  styleUrls: ['./industry-enquiry-list.component.scss']
})
export class IndustryEnquiryListComponent implements OnInit {
